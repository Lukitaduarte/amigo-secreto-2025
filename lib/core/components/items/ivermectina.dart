...
class Ivermectina extends GameDecoration with TapGesture, Vision {
  bool _observedPlayer = false;

  late TextPaint _textConfig;

  Ivermectina(Vector2 position)
      : super.withAnimation(
          animation: SpriteAnimation.load(
            'Items/ivermectina.png',
  ...
  void onTap() {
    if (_observedPlayer) {
      GetIt.instance.get<Inventory>().catchIvermectina();
      removeFromParent();
    }
  }
